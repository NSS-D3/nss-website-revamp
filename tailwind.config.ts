...
export default {
  ...
  content: [
    "./index.html",
    "./src/**/*.{js,jsx,ts,tsx}",
    "./client/**/*.{js,jsx,ts,tsx}", // Added this path for client folder if you have one
  ],
  theme: {
    screens: {
      'xs': '475px',
    ...
    extend: {
      fontFamily: {
        ...
        'display': ['Montserrat', 'Poppins', 'Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'],
      },
      borderRadius: {
        lg: "var(--radius)",
